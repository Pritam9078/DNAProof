        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="font-['Orbitron'] text-2xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-[#00FFFF] to-[#FF00FF]">
              DNA<span className="text-white">PROOF</span>
            </h1>
          </div>
          ...
          <AnimatePresence mode="wait">
            {activeSection === "upload" && (
              ...
              >
                ...
                />
                {selectedFile && (
                  <div className="mt-6 p-6 border border-[#00FFFF]/20 rounded-2xl bg-[#1a1a1a]">
                    <h3 className="text-lg font-['Orbitron'] text-[#00FFFF] mb-4">Complete Document Issuance</h3>
                    <p className="text-sm text-gray-400 mb-6">Confirm the details below to register this document on the blockchain with AI verification.</p>
                    <div className="flex gap-4">
                      <Button className="flex-1 bg-gradient-to-r from-[#8A2BE2] to-[#FF00FF] hover:opacity-90">
                        Issue Document
                      </Button>
                      <Button variant="outline" onClick={handleClearFile} className="border-gray-700">
                        Cancel
                      </Button>
                    </div>
                  </div>
