...
export default function PrivacyPolicy() {
  return (
    <LegalDocument title="Privacy Policy">
      ...
      <p>
        At DNAProof, we're committed to protecting your privacy while providing a decentralized storage 
      ...
      <p>
        When you upload files to DNAProof:
      </p>
      <ul className="list-disc pl-6 my-3 space-y-2">
      ...
      <p>
        DNAProof is not intended for children under 18. We do not knowingly collect information from 
      ...
      <p>
        ...
        through the platform or via the contact information you provide. Your continued use of DNAProof 
      ...
      <p>
        ...
        privacy@dnaproof.io or through our community channels.
      </p>
    </LegalDocument>
  );
}