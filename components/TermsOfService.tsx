...
export default function TermsOfService() {
  return (
    <LegalDocument title="Terms of Service">
      ...
      <p>
        Welcome to DNAProof ("we," "our," or "us"), a decentralized Web3 storage platform. By accessing 
        or using our services, you agree to be bound by these Terms of Service ("Terms"). Please read 
        these Terms carefully before using DNAProof.
      </p>

      <h2 className="text-xl text-[#00FFFF] mt-6 mb-3">2. Blockchain Technology & Decentralized Storage</h2>
      <p>
        DNAProof operates on blockchain technology and decentralized storage protocols including 
      ...
      <p>
        DNAProof uses Web3 wallet connections (such as MetaMask, WalletConnect, etc.) as the primary 
      ...
      <p>
        You agree not to use DNAProof to store or share:
      </p>
      <ul className="list-disc pl-6 my-3 space-y-2">
      ...
      <p>
        DNAProof utilizes smart contracts for metadata storage and access control. You acknowledge:
      </p>
      <ul className="list-disc pl-6 my-3 space-y-2">
      ...
      <p>
        Using DNAProof involves various fees:
      </p>
      <ul className="list-disc pl-6 my-3 space-y-2">
      ...
      <p>
        We reserve the right to terminate or suspend your access to DNAProof:
      </p>
      <ul className="list-disc pl-6 my-3 space-y-2">
      ...
      <p>
        We may update these Terms at any time. Continued use of DNAProof after changes constitutes 
      ...
      <p>
        For questions about these Terms, please contact us at support@dnaproof.io or through our 
        community channels.
      </p>
    </LegalDocument>
  );
